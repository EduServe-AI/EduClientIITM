...
export default function StudentSignup({ setIsSignin }: StudentSignupProps) {
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-white p-4 gap-6 lg:gap-10 lg:p-10">
      {/* SECTION 1: BRANDING / IMAGE (Left on Desktop, Top on Mobile) 
        Note: I swapped the order in code to make Layout standard, 
        but on Mobile 'flex-col' puts this first. 
        If you want this bottom on mobile, use 'flex-col-reverse' on parent and swap these blocks back.
        Based on your code 'flex-col-reverse', you had Form first.
        I will assume you want: Desktop [Image | Form], Mobile [Image (top) | Form (bottom)]?
        If you want Mobile: Form (Top), Image (Bottom), simply add 'flex-col-reverse lg:flex-row' to parent.
        
        Currently configured for: Desktop [Image Left | Form Right] scaling to fit screen.
      */}
      ...
      {/* SECTION 2: SIGNUP FORM (Right on Desktop) */}
      <div className="w-full lg:w-1/2 flex justify-center">
        {/* Added lg:w-full lg:max-w-xl to allow card to grow on big screens */}
