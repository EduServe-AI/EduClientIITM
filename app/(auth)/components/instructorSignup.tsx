...
export default function InstructorSignup({
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen bg-white p-4 gap-6 lg:gap-10 lg:p-10">
      ...
      <div className="hidden lg:flex flex-col justify-center items-center bg-neutral-100 rounded-lg w-full lg:w-1/2 h-full min-h-[500px] lg:h-auto p-10 space-y-4">
        {/* Heading */}
