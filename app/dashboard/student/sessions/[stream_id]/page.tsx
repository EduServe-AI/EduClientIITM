...
export default function SessionCall() {
  ...
  }, [student?.id, token, imageUrl, student?.username])
  ...
  // Wait for both student and token to be loaded
  if (studentLoading || isTokenLoading) {
    console.log(
      'Still loading... Student:',
      studentLoading,
      'Token:',
      isTokenLoading
    )
      ...
      <div className="flex items-center justify-center h-screen">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500">
            Student: {studentLoading ? 'Loading...' : 'Ready'} | Token:{' '}
  ...
  // Check if student is available after loading
  if (!student) {
    toast.error('Student context must be present')
    throw new Error('Student context must be present')
  }
