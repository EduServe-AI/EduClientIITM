                  ...
                  {instructor.languages && instructor.languages.length > 0 && (
                    <div className="mt-6 border-t border-border pt-4">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="text-sm font-medium text-accent-foreground ml-3">
            ...
            {instructor.skills && instructor.skills.length > 0 && (
              <Card className="border-border shadow-sm">
                <CardContent className="px-6 py-2">
                  <h2 className="mb-4 flex items-center gap-2 text-xl font-bold text-card-foreground">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {instructor.skills.map((skill: string) => (
                      <Badge
                        key={skill}
                        variant="outline"
                        // className="border-border bg-white px-4 py-2 text-sm font-medium text-black transition-colors hover:bg-black hover:text-white"
                      >
                        {skill}
                      </Badge>
                    ))}
